...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/logo_yofagroup.png
  AssetGenImage get logoYofagroup =>
      const AssetGenImage('assets/images/logo_yofagroup.png');
...
class $AssetsIconsMenuGen {
  ...
  /// File path: assets/icons/menu/barcodealat.svg
  SvgGenImage get barcodealat =>
      const SvgGenImage('assets/icons/menu/barcodealat.svg');

  /// File path: assets/icons/menu/callplan.svg
  SvgGenImage get callplan =>
      const SvgGenImage('assets/icons/menu/callplan.svg');

  /// File path: assets/icons/menu/catatan.svg
  SvgGenImage get catatan => const SvgGenImage('assets/icons/menu/catatan.svg');

  /// File path: assets/icons/menu/cuti.svg
  SvgGenImage get cuti => const SvgGenImage('assets/icons/menu/cuti.svg');
  ...
  /// File path: assets/icons/menu/kunjungan.svg
  SvgGenImage get kunjungan =>
      const SvgGenImage('assets/icons/menu/kunjungan.svg');
